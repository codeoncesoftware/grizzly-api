...
public class XslRuntimeController {

	@Autowired
	private XslRuntimeService xslRuntimeService;
	
	@PostMapping("/xsl")
	public ResponseEntity<String> handleResource(@RequestBody RuntimeRequest<?> request, HttpServletRequest req) throws MalformedURLException {
	    ...
	    return ResponseEntity.of(xslRuntimeService.handle(request,baseUrl));
